...
def generateConfigurations(case_study='Blending tank',maintenance_strategy=1):
    if case_study=='Blending tank':
        ...
        deltat = 1 # in seconds
        tmax = ndays*24*3600*deltat # simulation time in seconds
        ...
        u = {
            ...
            'PI': {
                ...
                'tauI':100, # controller time constant
               },
           'intError':0,
           'control':True,
           'dt':1
        ...
        f = { # Sensor faults
            'C': {
                'alpha':0.2, # minimum probability for failure
        ...
        r.update({
            'Shutdown': {
                'levelThreshold': 0.001, # level at which to switch from shutdown to shut
            },
            'Startup': {
        ...
        # Current alarms are wornings on any component, pre-allocated for speed
